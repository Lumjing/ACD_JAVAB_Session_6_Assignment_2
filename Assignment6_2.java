package exceptionDemo;       //This java file is inside package named package1 inside src folder.
...
class NegativeAgeException extends Exception      //Creating class NegativeAgeException as a child of Exception inbuilt class.
{
	...
	{
		return "\nGenerating NegativeAgeException if user inputs negative value for age.";         //returning String when exception occures.
	}
